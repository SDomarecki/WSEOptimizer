...
class GeneQQChange(GeneFundamental, ABC):
    def __init__(self):
        super().__init__()
        self.indicator = ""
    ...
    def condition(self, company: Company, day: date) -> bool:
        ...
        previous_indicator_value = company.fundamentals.at[prev_quarter, self.indicator]
    ...
    def condition_to_string(self) -> str:
        return f"{self.indicator} / PrevQ {self.indicator} {self.comparator} {self.compared_value:.2f}"
